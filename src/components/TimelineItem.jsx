...
const TimelineItem = ({ title, year, duration, detail }) => {
  return (
    <ol className="flex flex-col md-flex-row relative border-l border-stone-200 dark:border-stone-700 ">
      <li className="mb-10 ml-4 ">
        <div className="absolute w-1 h-3 bg-stone-200 rounded-full mt-1.5-left-1.5 border border-white dark:border-stone-900 dark:bg-stone-700" />
        ...
        <p className="my-2 text-base font-normal text-stone-500 dark:text-white">{detail}</p>
      </li>
    </ol>
  );
};
